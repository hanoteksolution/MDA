...
- `mobile/staff/` — staff workspace switcher (gym, pharmacy, hotel, restaurant KPIs)
...
```text
GET /mobile/bootstrap/?audience=staff → workspaces (staff_hub, gym/pharmacy/hotel/restaurant_staff, …)
