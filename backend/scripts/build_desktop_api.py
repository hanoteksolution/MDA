...
HIDDEN_IMPORTS = [
    ...
    "apps.futsal.models",
    "apps.futsal.apps",
    "apps.futsal.services.futsal_service",
    "apps.platform",
    "apps.platform.models",
    "apps.platform.apps",
    "apps.platform.services.platform_service",
    "apps.platform.services.sync_service",
    "apps.platform.services.sync_catalog",
    "apps.platform.services.desktop_provision",
    "apps.platform.management.commands.bootstrap_platform",
    "apps.platform.models.shop_group",
    "apps.platform.models.sync_snapshot",
